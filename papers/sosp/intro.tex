...
The underlying issue underlying the verification problem is that the current models
...
\va{These are just detailed versions of the contributions list. Let's merge.}
...
% \va{We really don't need this level of detail in the introduction.}
% The impossibility decomposes into two theorems. A
...
of verification effectiveness into text-channel and tensor-channel components,
characterize the cost-robustness tradeoff, and identify the format-dependent
...
% \va{Too much detail for intro.}
% The text channel is stronger than
...
% optimization targeting the signal itself. 
