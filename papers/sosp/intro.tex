...
Epistemic observability is distinct from model interpretability (understanding
\emph{why} a model activates a particular circuit) and from explainability
(generating post-hoc rationales for outputs). It asks a narrower question:
\emph{is this generation grounded or fabricated?} The answer comes from
signals that are byproducts of inference, not from understanding the
