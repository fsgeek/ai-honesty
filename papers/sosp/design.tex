...
\begin{itemize}
  ...
  which internal representation geometry exhibits discontinuous, incoherent structure. 
...
the one it actually performed. This asymmetry is the foundation of the
adversarial robustness argument: computational signals (entropy, attention
