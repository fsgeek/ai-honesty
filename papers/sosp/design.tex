...
\vspace{4pt}
\noindent\small%
\etok{0}{\ low\ }\etok{2}{\ mid\ }\etok{4}{\ high\ }\etok{6}{\ very high\ }%
\quad{\normalfont Entropy: blue = confident, brown = uncertain}
\caption{Generated output consisting of 43 tokens along with its entropy trace for the query \textit{What shape is wombat scat?} with mean entropy $H=1.147$, max entropy $H=4.315$. Token background color indicates per-token entropy: blue (confident/low entropy) through orange to brown (uncertain/high entropy).}
