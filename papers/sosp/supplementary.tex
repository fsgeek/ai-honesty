...
\textbf{Key finding}: Tensor-guided verification outperforms the text baseline at every budget level by +3.3--4.6 percentage points, demonstrating that internal signals provide more discrimination per unit of verification budget.
