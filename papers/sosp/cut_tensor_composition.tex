...
%%
%% WARNING (2026-08-18): the numbers below (tau = 0.6, grounded entropy 0.02,
%% fabrications > 0.8, Brennan-Kowalski chain) match NO committed data file.
%% exp22_composition_20260125 (same-day commit) injects tensor metadata as
%% text, has no threshold gate, Paris entropy 0.39, no Brennan-Kowalski, and
%% its own 'benefit' column reads neutral/neutral/negative/positive.
%% The DESIGN (gate follow-up calls on predecessor entropy) is sound and worth
%% running properly; the RESULTS here are unverified. Do not cite or reuse
%% these numbers. Never appeared in the arXiv or SOSP submissions.
%% ==========================================================================
