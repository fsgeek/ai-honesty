...
unknowable queries (mean = 0.79) than on knowable queries (mean = 0.50). The
self-report AUC is 0.36---worse than random, because the relationship is
\emph{inverted}. The model does not merely fail to report its epistemic state
honestly; it systematically misreports, claiming greater confidence precisely
...
self-report fails catastrophically. Only the tensor provides reliable access to
the epistemic state the model cannot help but reveal through its computation.
