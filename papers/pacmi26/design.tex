...
Persona monitoring work supports the asymmetry: activation
projections reveal distinct internal configurations for different epistemic
conditions even with similar text~\cite{lu2026assistantaxissituatingstabilizing}.
...
This shows where generation proceeded with confidence (suggesting retrieval of a stored pattern)
and where it proceeded with uncertainty (suggesting fabrication).
...
high uncertainty, the mismatch is detectable. The interface also exposes an
attention summary as a candidate complementary signal. The evaluation in
\autoref{sec:eval} uses entropy alone, so we make no empirical claim about
what attention adds.
...
archived at DOI \href{https://doi.org/10.5281/zenodo.22148524}{10.5281/zenodo.22148524}
(v1.0.6; all versions: \href{https://doi.org/10.5281/zenodo.21422488}{10.5281/zenodo.21422488});
