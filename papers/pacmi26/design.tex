...
Under current training objectives, models receive no explicit incentive to make 
such changes for the purpose of evading a telemetry-based monitor.
...
post-training does not erase the signal in our data.
