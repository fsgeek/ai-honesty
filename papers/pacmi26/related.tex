...
\fakepara{Epistemic evaluation and agent architectures.} \citeauthor{clark2025epistemicalignmentmediatingframework}
~\cite{clark2025epistemicalignmentmediatingframework} note that current interfaces lack structured ways
to specify uncertainty or sourcing; we provide the formal impossibility
explaining \emph{why} text-only evaluation cannot suffice. \citeauthor{wright2025predictionstructuringepistemic}~\cite{wright2025predictionstructuringepistemic} propose architectures with explicit propositions
